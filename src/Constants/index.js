...
export const AppText={
    hello:'Hello,',
    Iam:'I am ',
    MaheswariRavi:'Maheswari Ravi',
    aboutMeDescripion:`I'm an experienced Frontend Developer with 2+ years of experience in IT. My expertise includes designing user-friendly interfaces, seamlessly integrating APIs, and consistently delivering exceptional web experiences. I'm dedicated to the world of software development, always striving for excellence in my work.`,
    Skills:'Skills & ',
    Experties:'Experties',
    ...
    Contact:'Contact ',
    Us:'Us',
    copywriteText:'Copyright by Maheswari @2023'
